...
--      init.sql 다음에 실행됨
--   B) 수동 실행 :
--        psql -h localhost -U goggles -d goggles -f init/02-data.sql
--
-- 주의 :
...
(id, lecture_id, title, content, sort_order, duration_seconds,
 created_at, created_by, updated_at, updated_by)
VALUES ('c1010000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001',
...
(id, lecture_id, title, content, sort_order, duration_seconds,
 created_at, created_by, updated_at, updated_by)
VALUES ('c1020000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000002',
...
(id, lecture_id, title, content, sort_order, duration_seconds,
 created_at, created_by, updated_at, updated_by)
VALUES ('c1030000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000003',
...
(id, lecture_id, title, content, sort_order, duration_seconds,
 created_at, created_by, updated_at, updated_by)
VALUES ('c2010000-0000-0000-0000-000000000001', 'a2000000-0000-0000-0000-000000000001',
...
(id, lecture_id, title, content, sort_order, duration_seconds,
 created_at, created_by, updated_at, updated_by)
VALUES ('c2020000-0000-0000-0000-000000000001', 'a2000000-0000-0000-0000-000000000002',
...
(id, lecture_id, title, content, sort_order, duration_seconds,
 created_at, created_by, updated_at, updated_by)
VALUES ('c3010000-0000-0000-0000-000000000001', 'a3000000-0000-0000-0000-000000000001',
...
(id, lecture_id, title, content, sort_order, duration_seconds,
 created_at, created_by, updated_at, updated_by)
VALUES ('c3020000-0000-0000-0000-000000000001', 'a3000000-0000-0000-0000-000000000002',
...
('e3000000-0000-0000-0000-00000000000b',
 ...
 NOW() - INTERVAL '15 days', 'cccccccc-cccc-cccc-cccc-cccccccccccc');
-- 5일 후 환불
